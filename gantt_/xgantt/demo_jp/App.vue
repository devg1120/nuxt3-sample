<template>
  ...
  <div v-if="!isMulti" aria-label="Single">
    ...
    <button @click="() => (isDark = !isDark)">
      sw{{ isDark ? `Light` : `Dart` }}Mode
    </button>
    <button @click="handleClickReloadData">再割り当て</button>
    <button @click="handleClickEmpty">クリア</button>
    <button @click="handleClickModify">修正</button>
    <button @click="handleClickInsert">挿入</button>
    <button @click="handleClickInsertChildren">插入子</button>
    <button @click="handleClickDelete">削除</button>
    <button @click="handleClickColor">色</button>
    <button @click="() => (showCheckbox = !showCheckbox)">checkbox</button>
    <button @click="() => (showWeekend = !showWeekend)">weekend</button>
    <button @click="() => (showToday = !showToday)">today</button>
    <button @click="() => (showExpand = !showExpand)">expand</button>
    <button @click="() => (draggable = !draggable)">ドラッグ</button>
    <button @click="setSelected">選択</button>
    <button @click="jumpTo">ジャンプ</button>
    ...
    <button @click="() => (useProgress = !useProgress)">進捗</button>
  </div>

  <div v-else aria-label="Multi">
